...
def create_graph():
    with open('Income(csv).csv') as file:
        ...
        with open('Expenses(csv).csv') as ex_file:
            ...
            line_income.title = 'รายได้-รายจ่ายของประเทศไทยรวมทุกจังหวัดในแต่ละปี'
            ...
            line_income.render_to_file('Income_Thai_Home.svg')
create_graph()
